...
public class AccessRESTServiceWithInterpreter {
    ...
    protected static Logger logger = org.apache.logging.log4j.LogManager.getLogger(AccessRESTServiceWithInterpreter.class);
    ...
    public static void main(String[] args) {
         ...
         */
        ITouchpointCRUDServiceClient serviceProxy = (ITouchpointCRUDServiceClient) Proxy.newProxyInstance(ITouchpointCRUDServiceClient.class.getClassLoader(), new Class[]{ITouchpointCRUDServiceClient.class}, invocationHandler);
...
//		// 3) create a new touchpoint
        ...
        // comment-in the call to update() once this is handled
        /*
